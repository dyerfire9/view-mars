                ...
                <h2 className="footer-title">Contact</h2>
                    <div className="footer-contact-content"> 
                        ...
                        <div className="footer-contact-links">
                            <a href="https://github.com/dyerfire9/" target="_blank" className="footer-links"><BsMailbox2 style={window.width ? style1: style2}/>Email</a>
                            <a href="https://github.com/dyerfire9/" target="_blank" className="footer-links"><BsGithub style={window.width ? style1: style2}/>Github</a>
                            <a href="https://linkedin.com/in/abdulmannancomp/" target="_blank" className="footer-links"><BsLinkedin style={window.width ? style1: style2}/>LinkedIn</a>
                            <a href="https://dyerfire9.github.io/portfolio-site/" target="_blank" className="footer-links"><BsFillCreditCard2FrontFill style={window.width ? style1: style2}/>Website</a>
                        </div>
                    </div>
                </div>
            </div>
